...
https://zhuanlan.zhihu.com/p/662603875

- **Valine 使用案例**：适用于那些希望在他们的静态网站或博客中快速添加评论功能的用户，而不想自己搭建后端服务的用户。Valine 提供了一个简单而有效的解决方案，可以轻松地将评论集成到网站中。
- **Waline 使用案例**：适用于那些希望提供更多功能和自定义选项的用户，尤其是那些需要匿名评论、社交登录或其他高级功能的用户。Waline 提供了更多的灵活性和可定制性，使用户能够根据其特定需求进行更深入的调整。
