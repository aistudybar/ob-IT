AWS服务器#Ubuntu24安装（2）新建EC2实例；Mount数据盘；SFTP和SSH连接

http://localhost/discuz_pkb/forum.php?mod=viewthread&tid=103
...
sudo mount /dev/xvdbb /wwwrootVerify with:  
df -h  
...
sudo vi /etc/fstabAdd this line at the bottom (replace nvme1n1with your actual device):  
...
sftp [sftpuser@54.148.142.35](mailto:sftpuser@54.148.142.35)

![Ubuntu24安装（2）新建EC2实例；Mount数据盘；SFTP和SSH连接](https://repo.in4tree.com/2026/01/14_1768437141201.jpeg)

ssh [sftpuser@54.148.142.35](mailto:sftpuser@54.148.142.35) （应返回错误信息！只允许Key方式登录）
